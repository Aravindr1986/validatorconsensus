...
1) No new validators can be added to the initial set.
2) All the validators are fault tolerant.
3) The number submitted by the validator will always 0 or greater than zero ( will be nonnegative).
